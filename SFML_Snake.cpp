...
* \n
* **Goal of game:**\n
* To get the **highest score** by eating **Apples** and drinking **Beers** (if you have a luck to catch it)\n
* **if you pike your tail or crash a wall** you will loose life\n
*    \n
* ![Apple icon](apple.png)
*  -- gives you only one score but your tail will grow to ten segments\n
* ![Beer icon](beer-icon.png)
...
Beer* BeerCup;      ///< pointer to the Beer
		...
		Event event;
			...
			{	
				...
				if(game_time > LEVEL_TIME && game.get_state()==0) {
					...
					game_speed-=15000;	//Each new level must be faster then previous.
				}
			}
	}
