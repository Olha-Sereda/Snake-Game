 ...
 *	Array of objects of Beer class can be putten on the screen to \n
 *  make Snake not hungry.\n
 *  The main goal of game to eat Beer Cup as long as it possible and avoid all obstacles.\n
 *  \n
 * Example:
 *  \code
 *		fptr = new Beer(Vector2f(f_coord.left,f_coord.top));
 *  \endcode
 */
...
public:
	/*!
	Class constructor
	@param sf::Vector2f - abcolute coordinate of beer object location
	@see <A HREF="https://www.sfml-dev.org/documentation/2.5.1/classsf_1_1Vector2.php">sf::Vector2f</A>
	*/
	Beer(sf::Vector2f);
	/*!
	Virtual redefined function to draw Beer object on screen.\n
	...
	*/
	...
	/*!
	@return current absolute coodinates of beer object location
	@see <A HREF="https://www.sfml-dev.org/documentation/2.5.1/classsf_1_1Vector2.php">sf::Vector2f</A>
	*/
